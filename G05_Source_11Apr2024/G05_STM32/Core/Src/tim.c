...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(W1_ENC_T1C2_INB_GPIO_Port, W1_ENC_T1C2_INB_Pin);

    HAL_GPIO_DeInit(W1_ENC_T1C1_INA_GPIO_Port, W1_ENC_T1C1_INA_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, W2_ENC_T3C1_INA_Pin|W2_ENC_T3C2_INB_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, W3_ENC_T4C1_INA_Pin|W3_ENC_T4C2_INB_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(GPIOC, W4_ENC_T8C1_INA_Pin|W4_ENC_T8C2_INB_Pin);

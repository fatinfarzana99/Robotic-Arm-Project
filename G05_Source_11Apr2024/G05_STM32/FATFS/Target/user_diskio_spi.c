...
// spi 140MHz
#define FCLK_SLOW() { MODIFY_REG(SD_SPI_HANDLE.Instance->CFG1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_128); }	/* 437.5 KBits/s, Set SCLK = slow, approx 875.0 KBits/s*/
#define FCLK_FAST() { MODIFY_REG(SD_SPI_HANDLE.Instance->CFG1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_8); }	/*                Set SCLK = fast, approx  14.0 MBits/s */
// spi 80 MHz, _256 -> 312.5 KBits/s
// #define FCLK_SLOW() { MODIFY_REG(SD_SPI_HANDLE.Instance->CFG1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_128); }	/* Set SCLK = slow, approx 625 KBits/s*/
// #define FCLK_FAST() { MODIFY_REG(SD_SPI_HANDLE.Instance->CFG1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_8); }	/* Set SCLK = fast, approx 10 MBits/s */
